...
rewritten on 2026-08-12 when the first two landed overnight, which is the
hazard a handoff held across a working session carries: **its scope line is the
first thing to go stale, and the file name keeps the original scope forever.**
